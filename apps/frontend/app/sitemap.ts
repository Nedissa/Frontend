...
const BASE_URL = 'https://www.techpilots.se';
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/returpolicy`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.3 },
    { url: `${BASE_URL}/integritetspolicy`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.3 },
    { url: `${BASE_URL}/frakt-och-leverans`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.3 },
  ];
