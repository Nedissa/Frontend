  ...
  return (
    <html lang="sv" style={{ scrollbarGutter: 'stable', overflowY: 'scroll' }}>
      <head>
        ...
        <style>{`.ml-container{max-width:1280px;width:100%;padding-left:12px;padding-right:12px;}@media(min-width:768px){.ml-container{padding-left:0;padding-right:0;}}`}</style>
      </head>
