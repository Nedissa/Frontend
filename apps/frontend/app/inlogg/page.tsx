              ...
              {showLogin && !showResetModal && (
                <div className="p-8 rounded-lg shadow-sm" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>
                  ...
                  <div className="space-y-3 mt-6">
                    <button type="button" onClick={() => { setShowResetModal(true); setResetSent(false); setResetEmail(''); window.history.pushState({}, '', '/inlogg?reset=true'); }} className="w-full text-xs text-gray-500 hover:text-black py-2">
                      Glömt lösenord?
                    </button>
                  ...
                  {resetSent ? (
                    ...
                    <>
                      ...
                      <div className="text-center mt-4">
                        <button type="button" onClick={() => { setShowResetModal(false); window.history.pushState({}, '', '/inlogg'); }} className="text-xs text-gray-500 hover:text-black">Avbryt</button>
                      </div>
                    </>
                  )}
                </div>
