          ...
          <div style="background:#f4f4f4;border-radius:8px;padding:24px;margin:0 0 24px;">
            <table style="width:100%;border-collapse:collapse;font-size:0.875rem;">
              <tr>
                ...
                <td style="padding:6px 0;font-size:0.9rem;font-weight:600;color:#000;">${name}</td>
              </tr>
              <tr>
                <td style="padding:6px 0;font-size:0.8rem;color:#888;text-transform:uppercase;letter-spacing:0.05em;">E-post</td>
                <td style="padding:6px 0;font-size:0.9rem;color:#555;">${email}</td>
              </tr>
              <tr>
                <td style="padding:6px 0;font-size:0.8rem;color:#888;text-transform:uppercase;letter-spacing:0.05em;">Ämne</td>
                <td style="padding:6px 0;font-size:0.9rem;color:#333;">${subject}</td>
              </tr>
            </table>
          </div>
          <p style="font-size:0.9rem;color:#333;line-height:1.7;margin:0;white-space:pre-wrap;">${message}</p>
        </div>
        ${emailFooter}
      </div>
    `;
