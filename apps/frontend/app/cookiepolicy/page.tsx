      ...
      <InfoPageLayout title="Cookiepolicy" description="Hur vi använder cookies för att ge dig en bättre shoppingupplevelse." updatedDate="6 juni 2026" version="1.0">
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="mb-3">Hjälper oss förstå vilka produkter och kategorier som är populära. All data är anonym.</p>
            <ul className="mb-6">
              <li><strong>Google Analytics:</strong> Sidvisningar, sökningar och produktklick</li>
            </ul>

            <h3 className="font-bold mb-2">Funktionella cookies</h3>
            <p className="mb-3">Förbättrar din shoppingupplevelse genom att komma ihåg dina val.</p>
            <ul>
              <li><strong>Senast visade produkter:</strong> Visar produkter du nyligen tittat på</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Analytiska cookies:</strong> Sparas i upp till 26 månader</li>
            </ul>
          </section>

          <section>
            <h2 className="font-bold mb-4">4. Hur hanterar du cookies?</h2>
          ...
          <section>
            <h2 className="font-bold mb-4">5. Tredjepartscookies</h2>
            <p className="mb-3">Följande tredjepartstjänster kan sätta cookies på techpilots.se:</p>
            <ul>
              <li><strong>Google Analytics:</strong> Anonym besöksanalys för att förbättra produktutbudet</li>
              <li><strong>Klarna:</strong> Nödvändigt för att genomföra betalningar</li>
            </ul>
