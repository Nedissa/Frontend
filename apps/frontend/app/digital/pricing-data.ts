...
export const PRICES: PricePackage[] = [
  ...
  },
  {
    ...
    price: '4 990',
    suffix: '/ Mån',
    desc: 'För varumärken som säljer online. Färdig e-handelslösning eller skräddarsydd lösning för större behov, med betalning, produkthantering och snabb prestanda.',
    features: ['Shopify eller skräddarsydd lösning, efter behov', 'Betalning och sömlös kassaupplevelse (Stripe, Klarna)', 'Produkthantering och CMS', 'API-integrationer och tredjepartstjänster', 'Drift, backup och säkerhetsuppdateringar', 'Google-koppling och rapportering'],
    note: 'Skräddarsydda lösningar offereras separat',
    bindingMonths: 12,
    dark: false,
    popular: false,
