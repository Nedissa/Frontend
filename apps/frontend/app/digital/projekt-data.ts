...
export const PROJECTS: Project[] = [
  {
    ...
    year: '2025',
    status: 'Lanserad',
    image: '/digital/projekt/sagateatern/original-hero.avif',
    cardImage: '/digital/projekt/sagateatern/original-hero.avif',
    conclusionImage: '/digital/projekt/sagateatern/original-full-size.avif',
    tabletImage: '/digital/projekt/sagateatern/surfpadd.avif',
    ...
    steps: [
      ...
      { title: 'Detalj', description: 'Finjusteringar i typografi, färg och mellanrum som ger helheten dess känsla.', uxImprovements: ['Konsekvent typografi', 'Genomtänkt färgpalett', 'Finslipad mellanrumskänsla'] },
    ],
  },
  {
    slug: 'crownmatch',
    ...
    tabletImage: '/digital/projekt/crownmatch/original-jobbsokarguiden-ipad.avif',
    ...
    steps: [
      ...
      { title: 'Matchningar', description: 'Statistik och matchningsdata presenteras tydligt så användaren ser sin utveckling.', image: '/digital/projekt/crownmatch/original-hero.avif', uxImprovement: 'Tydligare uppmaningar (CTA)', uxImprovements: ['Tydligare uppmaningar (CTA)', 'Bättre datavisualisering', 'Ökad konvertering'] },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: 'Översikt', description: 'Startsidan sätter tonen. Tydlig identitet och en snabb väg till det besökaren letar efter.', uxImprovements: ['Fordonen i fokus', 'Modern och tydlig design', 'Snabbare laddning'] },
      ...
      { title: 'Detalj', description: 'Finjusteringar i typografi, färg och mellanrum som ger helheten dess känsla.', uxImprovements: ['Stärkt förtroendekänsla', 'Konsekvent varumärkeston', 'Finslipad mellanrumskänsla'] },
    ],
  },
  {
    ...
    tabletImage: '/digital/projekt/pistolero-studio/tablet-kontakt.avif',
    ...
    steps: [
      ...
      { title: 'Detalj', description: 'Finjusteringar i typografi, färg och mellanrum som ger helheten dess känsla.', uxImprovements: ['Studions unika stil', 'Konsekvent varumärkeston', 'Finslipad mellanrumskänsla'] },
    ],
  },
  {
    ...
    year: '2025',
    status: 'Lanserad',
    image: '/digital/projekt/ljuva-hem-i-mark/desktop.avif',
    cardImage: '/digital/projekt/ljuva-hem-i-mark/desktop.avif',
    conclusionImage: '/digital/projekt/ljuva-hem-i-mark/full-size.avif',
    tabletImage: '/digital/projekt/ljuva-hem-i-mark/surfpad.avif',
    ...
    steps: [
      ...
      { title: 'Detalj', description: 'Finjusteringar i typografi, färg och mellanrum som ger helheten dess känsla.', uxImprovements: ['Känsla av ordning', 'Konsekvent varumärkeston', 'Finslipad mellanrumskänsla'] },
    ],
  },
];
