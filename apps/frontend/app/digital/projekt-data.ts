...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: '2025',
    status: 'Lanserad',
    image: '/digital/projekt/crownmatch/hero-laptop-mockup-2.avif',
    cardImage: '/digital/projekt/crownmatch/hero-laptop-mockup-2.avif',
    tabletImage: '/digital/projekt/crownmatch/footer-logga-mockup.avif',
    ...
    steps: [
      { title: 'Översikt', description: 'Startsidan sätter tonen. Tydlig identitet och en snabb väg till det besökaren letar efter.', image: '/digital/projekt/crownmatch/mobile-mockup.avif', uxImprovement: 'Modernare design', uxImprovements: ['Modernare design', 'Tydligare hierarki', 'Snabbare laddning'] },
      ...
      { title: 'Matchningar', description: 'Statistik och matchningsdata presenteras tydligt så användaren ser sin utveckling.', image: '/digital/projekt/crownmatch/matchningar-phone-mockup.avif', uxImprovement: 'Tydligare uppmaningar (CTA)', uxImprovements: ['Tydligare uppmaningar (CTA)', 'Bättre datavisualisering', 'Ökad konvertering'] },
    ],
