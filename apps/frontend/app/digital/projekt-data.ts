...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    technologies: ['Next.js', 'Payload CMS'],
    steps: [
      { title: 'Översikt', description: 'Startsidan sätter tonen. Tydlig identitet och en snabb väg till det besökaren letar efter.', uxImprovements: ['Ljus, ren design', 'Förtroendeingivande känsla', 'Snabbare laddning'] },
