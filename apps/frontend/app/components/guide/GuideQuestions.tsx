...
export function GuideQuestions({ guideSlug }: { guideSlug: string }) {
  ...
  useEffect(() => {
    fetch(`/api/guide-questions?guide_slug=${guideSlug}`)
      .then(r => r.json())
  ...
  const handleVote = async (questionId: string, target: 'question' | 'answer', vote: 'like' | 'dislike') => {
    const res = await fetch(`/api/guide-questions/${questionId}/vote`, {
      method: 'POST',
    ...
    <div className="space-y-6 pb-8">
      <div className="pb-6 border-b border-gray-200">
        <p className="text-sm text-gray-700 leading-relaxed">
          Ställ frågor om guiden, så svarar vårt team.
        </p>
      </div>
      ...
      {!loading && questions.length === 0 && (
        <div>
          <p className="text-sm text-gray-600">Inga frågor har besvarats för denna guide än</p>
            ...
            <div className="border border-gray-200 rounded-lg p-3">
              ...
              <div className="mt-2">
                <VoteButtons
                  ...
                  votedKey={`guide_qa_vote_${q.id}_question`}
            ...
            <div className="border border-gray-200 rounded-lg p-3">
              ...
              <div className="mt-2">
                <VoteButtons
                  ...
                  votedKey={`guide_qa_vote_${q.id}_answer`}
