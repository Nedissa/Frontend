...
const SECTION_IMAGES: Record<string, string> = {
  barbara: '/assets/mega-barbara.png',
  stationara: '/assets/mega-stationara.png',
  datortillbehor: '/assets/mega-datortillbehor.png',
  processorer: '/assets/mega-processorer.png',
  moderkort: '/assets/mega-moderkort.png',
  grafikkort: '/assets/mega-grafikkort.png',
  ram: '/assets/mega-ram.png',
  lagringsenhet: '/assets/mega-lagring.png',
  natlagring: '/assets/mega-natlaggregat.png',
  'gaming-laptops': '/assets/mega-gaming-laptop.png',
  'gaming-pc': '/assets/mega-gaming-pc.png',
  'gaming-peripherals': '/assets/mega-gaming-tillbehor.png',
  smartphones: '/assets/mega-smartphones.png',
  'mobil-tillbehor': '/assets/mega-mobil-tillbehor.png',
  accesspunkter: '/assets/mega-accesspunkter.png',
  natsverksforlangarе: '/assets/mega-natverksforlangare.png',
  routrar: '/assets/mega-routrar.png',
  mesh: '/assets/mega-mesh.png',
  tv: '/assets/mega-tv.png',
  ljud: '/assets/mega-ljud.png',
  'tillbehor-tv': '/assets/mega-tv-tillbehor.png',
};
