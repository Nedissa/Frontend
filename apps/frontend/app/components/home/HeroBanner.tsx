...
export function HeroBanner({ collections }: { collections: Collection[] }) {
  ...
  return (
    ...
    <div className="relative z-0 flex justify-center w-full">
      <div
        className="relative max-w-[1080px] qhd:max-w-[1600px] w-full overflow-hidden flex items-center justify-center cursor-pointer bg-gray-200 hero-mobile-height"
