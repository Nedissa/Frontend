...
const TOOLS: Tool[] = [
  ...
  { name: 'HubSpot', category: 'CRM', featured: true, icon: Gear as IconType, mono: 'HS', desc: 'CRM & email' },
  { name: 'Klaviyo', category: 'CRM', featured: true, icon: Gear as IconType, mono: 'K', desc: 'E-commerce CRM' },
  ...
  { name: 'VS Code', category: 'Verktyg', icon: Code as IconType, mono: 'VS', desc: 'Kodredigerare' },
  ...
  { name: 'Cookiebot', category: 'Säkerhet', featured: false, icon: Cookie as IconType, mono: 'C', desc: 'GDPR & cookie-hantering' },
  { name: 'SSL/TLS', category: 'Säkerhet', featured: false, icon: Lock as IconType, mono: 'SSL', desc: 'Datakryptering' },
  { name: 'Hetzner Security', category: 'Säkerhet', featured: false, icon: SiHetzner, mono: 'HS', desc: 'Firewall & DDoS-skydd' },
