...
export default function ProductDetailClient({
  ...
  return (
    <div className="pt-[20px]">
      ...
      <div className="w-full max-w-[1080px] qhd:max-w-[1600px] mx-auto flex flex-col md:flex-row gap-4" style={{ alignItems: 'stretch' }}>
      ...
      <div className="md:hidden w-full max-w-[1080px] qhd:max-w-[1600px] mx-auto flex flex-col gap-2 mt-2">
      ...
      {alsoLikeProducts.length > 0 && (
        <div className="w-full max-w-[1080px] qhd:max-w-[1600px] mx-auto mt-12 px-4">
      ...
      {recentlyViewed.length > 0 && (
        <div className="w-full max-w-[1080px] qhd:max-w-[1600px] mx-auto mt-12 mb-8 px-4">
