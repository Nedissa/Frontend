              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea rows={6} value={message} onChange={(e) => setMessage(e.target.value)} className="w-full px-4 py-2 pr-10 focus:outline-none border border-gray-200 focus:border-black" placeholder="Beskriv ditt ärende här..." required />
