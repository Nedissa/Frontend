...
## Projektsidan (webbstudio/projekt/[slug])
Byggd med Tailwind-klasser direkt i JSX (inte inline styles, inte separat CSS-fil). Varje sektion är en egen `<section>` som spänner full bredd, med en inre `<div className="max-w-[1440px] mx-auto px-12">` för innehållet — mönster att följa för nya webbstudio-sidor.
